...
p.x_init = [1; 1.5];                      % initial state
p.u_min = 0;                            % min input
p.u_max = 24;                           % max input
p.x_min = [0.5; 0.5];                   % min state
p.x_max = [25; 25];                     % max state
p.u_term = 10;                          % terminal set bound on input 
p.x_term = 10;                           % terminal set bound on state
